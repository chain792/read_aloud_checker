<template>
  <v-container>
    <div class="text-body-1">
      <h1 class="text-center text-h4 mt-3 font-weight-medium">利用規約</h1>
      <v-divider class="my-4"></v-divider>
      <p>
        この利用規約（以下，「本規約」といいます。）は，音読スター（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </p>
